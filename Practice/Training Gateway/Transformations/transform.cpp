...
// vector<vector<char>> rotateOneEighty(vector<vector<char>> square) {
	
// }

// vector<vector<char>> rotateTwoSeventy(vector<vector<char>> square) {
	
// }

// vector<vector<char>> reflectHoriz(vector<vector<char>> square) {
...
int main() {
	...
	if(equalSquare(transformSquare, rotatedNinety)) {
		...
		vector<vector<char>> combRotatedOneEighty = rotatedOneEighty(reflectedHoriz);
		vector<vector<char>> combRotatedTwoSeventy = rotatedTwoSeventy(reflectedHoriz);
